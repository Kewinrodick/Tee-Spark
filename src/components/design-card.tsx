...
export function DesignCard({ design, className }: DesignCardProps) {
  return (
    <Link href={`/designs/${design.id}`} className="group block">
      <Card className={cn("overflow-hidden h-full flex flex-col transition-all duration-300 hover:border-primary hover:shadow-lg hover:shadow-primary/20", className)}>
