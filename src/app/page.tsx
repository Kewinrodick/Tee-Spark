...
export default function Home() {
  ...
  const filteredDesigns = useMemo(() => {
    ...
    return allDesigns.filter(design => {
      ...
      const tags = ['abstract', 'minimalist', 'modern', 'geometric']; 
      return (
    ...
    <>
      ...
      <div className="container py-8 md:py-12" id="trending-designs">
        <div className="flex flex-col md:flex-row justify-center items-center md:justify-between mb-8 gap-4">
             <h2 className="text-3xl font-bold tracking-tighter md:text-5xl font-headline text-center">
                {searchTerm ? 'Search Results' : 'Trending Designs'}
            </h2>
